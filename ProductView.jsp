<%@page import="onlinegroceryshopping.controller.ProductCtl"%>
<%@page import="onlinegroceryshopping.util.HTMLUtility"%>
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="card">
            <jsp:useBean id="bean" class="onlinegroceryshopping.bean.ProductBean"
