<%@page import="onlinegroceryshopping.controller.CheckoutCtl"%>
<%@page import="onlinegroceryshopping.bean.ProductBean"%>
<%@page import="onlinegroceryshopping.model.ProductModel"%>
                ...
                <table class="table table-striped">
               	 ...
               	 %>
                        <tr>
                            ...
                            <td class="text-right">RM<%=pBean.getPrice()%></td>
                             <td class="text-right">RM<%=bean.getFinalAmount()%></td>
                            <td></td>
                      			<% 
                       ...
                       %>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>Shipping</td>
                            <td class="text-right">RM<%=sipping%></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            ...
                            <td class="text-right"><strong>RM<%=sipping+n3%></strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
