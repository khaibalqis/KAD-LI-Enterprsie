<%@page import="onlinegroceryshopping.controller.ContectCtl"%>
<%@page import="onlinegroceryshopping.util.DataUtility"%>
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <jsp:useBean id="bean" class="onlinegroceryshopping.bean.ContectBean"
        ...
        <div class="col-12 col-sm-4">
                ...
                <div class="card-header bg-success text-white text-uppercase"><i class="fa fa-home"></i> Contact Us</div>
                <div class="card-body">
                    <p>KAD-LI ENTERPRISE,</p>
                    <p>Universiti Sains Islam Malaysia (USIM),</p>
                    <p>71800 Nilai, Negeri Sembilan.</p>
                    <p>Email : kadlient@usim.com</p>
                    <p>Office No : +0345678765</p>
