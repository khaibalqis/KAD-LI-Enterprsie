<%@page import="onlinegroceryshopping.controller.MyProfileCtl"%>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <jsp:useBean id="bean" class="onlinegroceryshopping.bean.UserBean"
				...
				value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="Enter Email Address..." 
                                value="<%=DataUtility.getStringData(bean.getEmailAddress())%>" >
